...
const EXPO_PUBLIC_API_BASE_URL = process.env.EXPO_PUBLIC_EXPO_PUBLIC_API_BASE_URL;
...
export async function enablePushAsync(apiBase = EXPO_PUBLIC_API_BASE_URL) {
  // 0) Quick sanity checks
  if (!apiBase) {
    console.warn('EXPO_PUBLIC_API_BASE_URL is undefined — set EXPO_PUBLIC_EXPO_PUBLIC_API_BASE_URL');
...
export async function unsubscribePushAsync(apiBase = EXPO_PUBLIC_API_BASE_URL) {
...
export async function ensureRegistered(apiBase = EXPO_PUBLIC_API_BASE_URL) {
